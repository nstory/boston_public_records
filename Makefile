...
$(POLICE_REQUESTS_CSV): $(POLICE_REQUESTS_PDF) src/tocsv.rb
	( echo "Reference No,Request Status,Create Date,Req. Compl. Date,Close Date,Assigned Dept,Customer Full Name,Company Name" ; ROW_REGEXP='^\w\d\d' FIELD_COUNT=8 ruby src/tocsv.rb $(POLICE_REQUESTS_PDF) ) > $(POLICE_REQUESTS_CSV)
